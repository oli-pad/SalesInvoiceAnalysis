...
def get_retailer_list(retailer_name):
    dict = {"TESC0":"TES01","SAINSBURY":"SAI01","COOP":"COO01"}
    return dict[retailer_name]
...
#For User Input
Client_Code=get_client_list(client_folder.upper())
Retailer_Code=get_retailer_list(retailer_folder.upper())
Date_period_1=start_date
Date_period_2=end_date
